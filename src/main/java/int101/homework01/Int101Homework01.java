...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
       System.out.println("bmi = " + MyUtill.calculateBMI(47, 1.65));
       System.out.println("avg = " + MyUtill.average(184, 222, 333));
      /*
   ...
   static void work04UseOfObjectClass() {
       ...
       BankAccount bank1 = new BankAccount(21,person1);
       BankAccount bank2 = new BankAccount(1,person2);
